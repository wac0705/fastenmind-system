...
type Handlers struct {
	...
	EngineerAssignment *EngineerAssignmentHandler
	ProcessCost        *ProcessCostHandler
...
func NewHandlers(services *service.Services) *Handlers {
	return &Handlers{
		...
		EngineerAssignment: NewEngineerAssignmentHandler(services.EngineerAssignment),
		ProcessCost:        NewProcessCostHandler(services.ProcessCost),
