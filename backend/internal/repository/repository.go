...
type Repositories struct {
	...
	EngineerAssignment *EngineerAssignmentRepository
	ProcessCost        *ProcessCostRepository
...
func NewRepositories(db *gorm.DB) *Repositories {
	return &Repositories{
		...
		EngineerAssignment: NewEngineerAssignmentRepository(db),
		ProcessCost:        NewProcessCostRepository(db),
